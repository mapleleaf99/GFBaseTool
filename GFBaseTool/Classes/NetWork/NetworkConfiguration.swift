...
/// 网络请求全局配置，通过 GFNetworkConfiguration.shared 修改
public struct GFNetworkConfiguration {
    ...
    /// 全局共享配置实例
    public static var shared = GFNetworkConfiguration()
}

/// 网络层统一错误类型
public enum GFNetworkError: LocalizedError {
    /// 业务错误（code 非成功码）
